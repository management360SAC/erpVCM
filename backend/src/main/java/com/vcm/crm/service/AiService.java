...
public class AiService {
    ...
    private String[] callGeminiImageGeneration(String userPrompt) throws Exception {
        String fullPrompt =
                ...
                "Design requirements: " +
                "- Leave a clean empty white strip at the very top of the image (about 24% of total height) with absolutely no text, icons or graphics, reserved for a company logo overlay. This strip must be completely blank white. " +
